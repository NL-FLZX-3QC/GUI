...
public class CounterTest2 {
    ...
    public void createFrame() {
        ...
        jPanel1.add(ActionButtonInput(buttonDiv));
        jPanel1.add(ActionButtonInput(buttonCE));
        jPanel1.add(ActionButtonInput(buttonC));
        jPanel1.add(ActionButtonInput(buttonDel));


        //设置按钮4,5,6，-
        JPanel jPanel2 = new JPanel(new GridLayout(1,4,5,5));
        jPanel2.add(ActionButtonInput(button1x));
        jPanel2.add(ActionButtonInput(button2x));
        jPanel2.add(ActionButtonInput(buttonI));
        jPanel2.add(ActionButtonInput(buttonDiv));

        //设置按钮1,2,3，*
        JPanel jPanel3 = new JPanel(new GridLayout(1,4,5,5));
        jPanel3.add(ActionButtonInput(button7));
        jPanel3.add(ActionButtonInput(button8));
        jPanel3.add(ActionButtonInput(button9));
        jPanel3.add(ActionButtonInput(buttonMul));

        //设置按钮   清除，0，/ =
        JPanel jPanel4 = new JPanel(new GridLayout(1,4,5,5));
        jPanel4.add(ActionButtonInput(button4));
        jPanel4.add(ActionButtonInput(button5));
        jPanel4.add(ActionButtonInput(button6));
        // 设置等于按钮
        jPanel4.add(ActionButtonEqu(buttonSub));

        //设置删除按钮为一行一列，5个像素点
        JPanel jPanel5 = new JPanel(new GridLayout(1,4,5,5));
        jPanel5.add(DelButton(button1));
        jPanel5.add(DelButton(button2));
        jPanel5.add(DelButton(button3));
        jPanel5.add(DelButton(buttonAdd));
        JPanel jPanel6 = new JPanel(new GridLayout(1,4,5,5));
        jPanel6.add(DelButton(buttonCge));
        jPanel6.add(DelButton(button0));
        jPanel6.add(DelButton(buttonDot));
        jPanel6.add(DelButton(buttonEqu));
